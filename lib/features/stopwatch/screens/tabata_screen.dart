...
import 'package:fitness_app/features/main/domain/models/tabata.dart';
...
class TabataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var provider = context.read<StopwatchProvider>() as StopwatchTabataProvider;
                  ...
                  SizedBox(
                    ...
                    child: ProgressCounter(
                      current: (context.watch<StopwatchProvider>()
                              as StopwatchTabataProvider)
                          .progress,
                      max: (provider.bloc as Tabata).exercises.length,
                    ),
                  ),
                ],
              ),
