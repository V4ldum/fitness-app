...
class ForTimeScreen extends StatelessWidget {
  const ForTimeScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var provider =
        context.read<StopwatchProvider>() as StopwatchForTimeProvider;
          ...
          children: [
            ...
            Container(
              ...
              child: StopwatchButton(
                onTap: provider.endWorkout,
                text: Strings.forTimeButton,
              ),
            ),
            Expanded(
              child: Container(
